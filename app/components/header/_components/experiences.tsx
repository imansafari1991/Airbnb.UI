...
<GuestPart   title="Pets" description="" max={6} initialValue={'0'} onCountChange={setPets}    reset={resetAll}></GuestPart>
      ...
      <div className="flex space-x-4">
        ...
        <div className="border-l border-gray-300 h-full"></div>
        <div className="flex flex-col">
          <span className="text-xs text-gray-500">Date pick</span>
          <input
            type="text"
            placeholder="Add dates"
            className="bg-transparent focus:outline-none text-sm"
  ...
  <div className='flex flex-col ms-2'>
        <span className="text-xs text-gray-500">Who</span>
          ...
          <button
            className="flex justify-center items-center rounded-full w-[25px] h-[25px] p-2 text-xs hover:bg-gray-200	"
